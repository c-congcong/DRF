...
from app_day3_lx.models import Book
from app_day3_lx.serializers import BookModelSerializer, BookDeModelSerializer, BookModelSerializerV2
...
class BookAPIView(APIView):
    def get(self, request, *args, **kwargs):
        ...
        if book_id:
            ...
            book = BookModelSerializer(book_obj).data
            return Response({
